// Office Scripts Text Renderer

const text = "Rendered with ♥ by Office Scripts";   // Text and emojis!
const fontSize = 12;
const fontFamily = "Times New Roman"; // Comic Sans MS, Times New Roman, Arial, Courier New, etc.
const fontStyle = "bold";   // italic, bold italic

// Single color only works when renderRainbowColor is false
const textColor = "red";
const renderRainbowColor = false;
const rainbowColorStop1 = "#ff0000";
const rainbowColorStop2 = "#00ff00";
const rainbowColorStop3 = "#0000ff";
...
class ImageInfo {
  public static fromText(text: string): ImageInfo {
    ...
    if (renderRainbowColor) {
      ...
      gradient.addColorStop(0, rainbowColorStop1);
      gradient.addColorStop(0.5, rainbowColorStop2);
      gradient.addColorStop(1, rainbowColorStop3);
